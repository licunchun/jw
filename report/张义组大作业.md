...
1. studentsTable结构
    ...
    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/studentsTable.png" alt="studentsTable" style="zoom: 50%;" />

2. teachersTable结构

    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/teachersTable.png" alt="teachersTable" style="zoom:50%;" />

3. managersTable结构

    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/managersTable.png" alt="managersTable" style="zoom:50%;" />

4. coursesTable结构

    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/coursesTable.png" alt="coursesTable" style="zoom:50%;" />
...
对应的set方法![set](/C:\Users\23323\Desktop\temp\Service/pictures/students.png)

一些辅助的静态方法![static](/C:\Users\23323\Desktop\temp\Service/pictures/static.png)
...
1. codeTeacherTable表结构
    ...
    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/codeTeacherTable.png" alt="codeTeacherTable" style="zoom:50%;" />

2. codeStudentTable表结构

    <img src="/C:\Users\23323\Desktop\temp\Service/pictures/codeStudentTable.png" alt="codeStudentTable" style="zoom:50%;" />

这两个表实时变化codeTeacher根据开课,删课而变化,存储课程编号和老师ID,无主键

 <img src="/C:\Users\23323\Desktop\temp\Service/pictures/codeTeacher.png" alt="codeTeacher" style="zoom:50%;" />
